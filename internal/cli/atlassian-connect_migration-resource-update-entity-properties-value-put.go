...
func newAtlassianConnectMigrationResourceUpdateEntityPropertiesValuePutCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			if cmd.Flags().Changed("entity-type") {
				allowedEntityType := []string{"IssueProperty", "CommentProperty", "DashboardItemProperty", "IssueTypeProperty", "ProjectProperty", "UserProperty", "WorklogProperty", "BoardProperty", "SprintProperty"}
	...
	cmd.Flags().StringVar(&flagEntityType, "entity-type", "IssueProperty", "The type indicating the object that contains the entity properties. (one of: IssueProperty, CommentProperty, DashboardItemProperty, IssueTypeProperty, ProjectProperty, UserProperty, WorklogProperty, BoardProperty, SprintProperty)")
