...
func newDirectoriesGroupsCreateOrgsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://api.atlassian.com/admin/v2/orgs/{orgId}/directories/{directoryId}/groups/{groupId}/memberships"
	...
	cmd.Flags().StringVar(&bodyAccountId, "account-id", "", "Every user has a unique ID. Find a user’s account ID by using the [Get users endpoint](https://developer.atlassian.")
