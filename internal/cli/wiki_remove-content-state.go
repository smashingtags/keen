...
func newWikiRemoveContentStateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagStatus, "status", "", "status of content state from which to delete state. Can be draft or archived (one of: current, draft)")
