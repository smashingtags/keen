...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Jira Pp Cli",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("JIRA_CLOUD_PLATFORM_USERNAME") != "" {
				envStillSet = "JIRA_CLOUD_PLATFORM_USERNAME"
			}
			if envStillSet == "" && os.Getenv("JIRA_CLOUD_PLATFORM_PASSWORD") != "" {
				envStillSet = "JIRA_CLOUD_PLATFORM_PASSWORD"
			}
