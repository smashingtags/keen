...
func newForgeGetAppPropertyKeysCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Aliases:     []string{"list"},
		Short:       "Returns all property keys for the Forge app.",
		Example:     "  jira-pp-cli-pp-cli forge get-app-property-keys",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "forge", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
