...
func newAddonsDistributionGetAddons2Cmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://marketplace.atlassian.com/rest/2/addons/{addonKey}/distribution/application"
