...
func newIssuesecurityschemesLevelRemoveCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagReplaceWith, "replace-with", "", "The ID of the issue security level that will replace the currently selected level.")
