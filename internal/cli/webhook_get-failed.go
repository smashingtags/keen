...
func newWebhookGetFailedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			}, nil, flagAll, "after", "cursor", "maxResults", "", "", cmd.ErrOrStderr())
			if err != nil {
	...
	cmd.Flags().IntVar(&flagMaxResults, "max-results", 0, "The maximum number of webhooks to return per page.")
	cmd.Flags().IntVar(&flagAfter, "after", 0, "The time after which any webhook failure must have occurred for the record to be returned")
