...
func newWikiGetContentDescendantsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagExpand, "expand", "", "A multi-value parameter indicating which properties of the children to expand, where")
