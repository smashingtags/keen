...
func newSoftwareGetApproximateIssueCountForBacklogCmd(flags *rootFlags) *cobra.Command {
	var flagJql string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "software", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
