...
func newAtlassianAccessUsersRolesAssignCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://api.atlassian.com/admin/v1/orgs/{orgId}/users/{userId}/roles/assign"
	...
	cmd.Flags().StringVar(&bodyResource, "resource", "", "Use the [Get Workspaces API](https://developer.atlassian.")
	cmd.Flags().StringVar(&bodyRole, "role", "", "Role to assign/revoke for a user")
