...
func newJqlSanitiseQueriesCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyQueries, "queries", "", "The list of JQL queries to sanitize. Must contain unique values. Maximum of 20 queries.")
