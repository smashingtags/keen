...
func newPlansGetPlanCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "plans", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
	...
	cmd.Flags().BoolVar(&flagUseGroupId, "use-group-id", false, "Whether to return group IDs instead of group names. Group names are deprecated.")
