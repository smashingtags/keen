...
func newApplicationsGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://marketplace.atlassian.com/rest/2/applications/{applicationKey}"
			path = replacePathParam(path, "applicationKey", args[0])
			params := map[string]string{}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "applications", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
