...
func newServicedeskapiGetAttachmentsForRequestCmd(flags *rootFlags) *cobra.Command {
	var flagStart int
	var flagLimit int
	var flagAll bool
	...
	cmd.Flags().IntVar(&flagStart, "start", 0, "The starting index of the returned attachment. Base index: 0.")
	cmd.Flags().IntVar(&flagLimit, "limit", 50, "The maximum number of comments to return per page. Default: 50.")
