...
func newFieldContextGetIssueTypeMappingsForCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagContextId, "context-id", "", "The ID of the context. To include multiple contexts, provide an ampersand-separated list.")
