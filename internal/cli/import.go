...
but do not stop the import.`,
  ...
  jira-pp-cli-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  jira-pp-cli-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | jira-pp-cli-pp-cli import <resource> --input -`,
