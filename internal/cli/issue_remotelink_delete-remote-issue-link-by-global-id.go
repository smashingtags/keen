...
func newIssueRemotelinkDeleteRemoteIssueLinkByGlobalIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !cmd.Flags().Changed("global-id") && !flags.dryRun {
				return fmt.Errorf("required flag \"%s\" not set", "global-id")
			}
	...
	cmd.Flags().StringVar(&flagGlobalId, "global-id", "", "The global ID of a remote issue link.")
