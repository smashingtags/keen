...
func newEventActionsPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://api.atlassian.com/admin/v1/orgs/{orgId}/event-actions"
			if len(args) < 1 {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "event-actions", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
