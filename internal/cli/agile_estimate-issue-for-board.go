...
func newAgileEstimateIssueForBoardCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if flagBoardId != "" {
				params["boardId"] = fmt.Sprintf("%v", flagBoardId)
			}
	...
	cmd.Flags().StringVar(&flagBoardId, "board-id", "", "The ID of the board required to determine which field is used for estimation.")
