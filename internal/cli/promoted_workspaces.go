...
func newWorkspacesPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://api.atlassian.com/admin/v2/orgs/{orgId}/workspaces"
			if len(args) < 1 {
	...
	cmd.Flags().StringVar(&bodyCursor, "cursor", "", "A base-64 encoded continuation token used for pagination.")
	cmd.Flags().IntVar(&bodyLimit, "limit", 20, "Specifies the maximum page size.")
	cmd.Flags().StringVar(&bodyQuery, "query", "", "Possible operators/operand in the event query.")
