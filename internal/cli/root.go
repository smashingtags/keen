...
Run 'jira-pp-cli-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.AddCommand(newAddonCategoriesCmd(flags))
	rootCmd.AddCommand(newAddonsCmd(flags))
	rootCmd.AddCommand(newAgileCmd(flags))
	rootCmd.AddCommand(newAnnouncementBannerCmd(flags))
	rootCmd.AddCommand(newAppCmd(flags))
	rootCmd.AddCommand(newAppAccessSettingsCmd(flags))
	rootCmd.AddCommand(newApplicationPropertiesCmd(flags))
	rootCmd.AddCommand(newApplicationroleCmd(flags))
	rootCmd.AddCommand(newApplicationsCmd(flags))
	rootCmd.AddCommand(newAssetsCmd(flags))
	rootCmd.AddCommand(newAtlassianAccessEventsCmd(flags))
	rootCmd.AddCommand(newAtlassianAccessUsersCmd(flags))
	rootCmd.AddCommand(newAtlassianConnectCmd(flags))
	rootCmd.AddCommand(newAttachmentCmd(flags))
	rootCmd.AddCommand(newAvatarCmd(flags))
	rootCmd.AddCommand(newBuildsCmd(flags))
	rootCmd.AddCommand(newComponentCmd(flags))
	rootCmd.AddCommand(newConfigCmd(flags))
	rootCmd.AddCommand(newConfigurationCmd(flags))
	rootCmd.AddCommand(newDashboardCmd(flags))
	rootCmd.AddCommand(newDataPolicyCmd(flags))
	rootCmd.AddCommand(newDeploymentsCmd(flags))
	rootCmd.AddCommand(newDevinfoCmd(flags))
	rootCmd.AddCommand(newDevopscomponentsCmd(flags))
	rootCmd.AddCommand(newDirectoryCmd(flags))
	rootCmd.AddCommand(newDomainsCmd(flags))
	rootCmd.AddCommand(newExpressionCmd(flags))
	rootCmd.AddCommand(newFeatureflagsCmd(flags))
	rootCmd.AddCommand(newFieldCmd(flags))
	rootCmd.AddCommand(newFieldconfigurationCmd(flags))
	rootCmd.AddCommand(newFieldconfigurationschemeCmd(flags))
	rootCmd.AddCommand(newFilterCmd(flags))
	rootCmd.AddCommand(newForgeCmd(flags))
	rootCmd.AddCommand(newGroupCmd(flags))
	rootCmd.AddCommand(newIssueCmd(flags))
	rootCmd.AddCommand(newIssueLinkCmd(flags))
	rootCmd.AddCommand(newIssueLinkTypeCmd(flags))
	rootCmd.AddCommand(newIssuesecurityschemesCmd(flags))
	rootCmd.AddCommand(newIssuetypeCmd(flags))
	rootCmd.AddCommand(newIssuetypeschemeCmd(flags))
	rootCmd.AddCommand(newIssuetypescreenschemeCmd(flags))
	rootCmd.AddCommand(newJiraCloudPlatformSearchCmd(flags))
	rootCmd.AddCommand(newJiraCloudPlatformVersionCmd(flags))
	rootCmd.AddCommand(newJiraCloudPlatformWorkflowCmd(flags))
	rootCmd.AddCommand(newJqlCmd(flags))
	rootCmd.AddCommand(newLicenseCmd(flags))
	rootCmd.AddCommand(newLicenseTypesCmd(flags))
	rootCmd.AddCommand(newMypreferencesCmd(flags))
	rootCmd.AddCommand(newNotificationschemeCmd(flags))
	rootCmd.AddCommand(newOperationsCmd(flags))
	rootCmd.AddCommand(newOrgsCmd(flags))
	rootCmd.AddCommand(newPermissionsCmd(flags))
	rootCmd.AddCommand(newPermissionschemeCmd(flags))
	rootCmd.AddCommand(newPlansCmd(flags))
	rootCmd.AddCommand(newPoliciesCmd(flags))
	rootCmd.AddCommand(newPriorityCmd(flags))
	rootCmd.AddCommand(newPriorityschemeCmd(flags))
	rootCmd.AddCommand(newProductsCmd(flags))
	rootCmd.AddCommand(newProjectCmd(flags))
	rootCmd.AddCommand(newProjectCategoryCmd(flags))
	rootCmd.AddCommand(newProjectTemplateCmd(flags))
	rootCmd.AddCommand(newProjectvalidateCmd(flags))
	rootCmd.AddCommand(newRedactCmd(flags))
	rootCmd.AddCommand(newRemotelinksCmd(flags))
	rootCmd.AddCommand(newResolutionCmd(flags))
	rootCmd.AddCommand(newRoleCmd(flags))
	rootCmd.AddCommand(newScreensCmd(flags))
	rootCmd.AddCommand(newScreenschemeCmd(flags))
	rootCmd.AddCommand(newSecurityCmd(flags))
	rootCmd.AddCommand(newServicedeskapiCmd(flags))
	rootCmd.AddCommand(newSettingsCmd(flags))
	rootCmd.AddCommand(newSoftwareCmd(flags))
	rootCmd.AddCommand(newStatusCmd(flags))
	rootCmd.AddCommand(newStatuscategoryCmd(flags))
	rootCmd.AddCommand(newStatusesCmd(flags))
	rootCmd.AddCommand(newUiModificationsCmd(flags))
	rootCmd.AddCommand(newUniversalAvatarCmd(flags))
	...
	rootCmd.AddCommand(newWorkflowschemeCmd(flags))
	rootCmd.AddCommand(newWorklogCmd(flags))
	...
	rootCmd.AddCommand(newAtlassianAccessGroupsPromotedCmd(flags))
	rootCmd.AddCommand(newAuditingPromotedCmd(flags))
	rootCmd.AddCommand(newChangelogPromotedCmd(flags))
	rootCmd.AddCommand(newClassificationLevelsPromotedCmd(flags))
	rootCmd.AddCommand(newCommentPromotedCmd(flags))
	rootCmd.AddCommand(newCustomFieldOptionPromotedCmd(flags))
	rootCmd.AddCommand(newDirectoriesPromotedCmd(flags))
	rootCmd.AddCommand(newEventActionsPromotedCmd(flags))
	rootCmd.AddCommand(newEventsPromotedCmd(flags))
	rootCmd.AddCommand(newEventsStreamPromotedCmd(flags))
	rootCmd.AddCommand(newGroupsPromotedCmd(flags))
	rootCmd.AddCommand(newGroupuserpickerPromotedCmd(flags))
	rootCmd.AddCommand(newInstancePromotedCmd(flags))
	rootCmd.AddCommand(newInternalPromotedCmd(flags))
	rootCmd.AddCommand(newIssuesPromotedCmd(flags))
	rootCmd.AddCommand(newLabelPromotedCmd(flags))
	rootCmd.AddCommand(newMypermissionsPromotedCmd(flags))
	rootCmd.AddCommand(newMyselfPromotedCmd(flags))
	rootCmd.AddCommand(newProjectsPromotedCmd(flags))
	rootCmd.AddCommand(newSecuritylevelPromotedCmd(flags))
	rootCmd.AddCommand(newServerInfoPromotedCmd(flags))
	rootCmd.AddCommand(newTaskPromotedCmd(flags))
