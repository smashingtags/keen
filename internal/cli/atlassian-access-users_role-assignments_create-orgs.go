...
func newAtlassianAccessUsersRoleAssignmentsCreateOrgsCmd(flags *rootFlags) *cobra.Command {
	var bodyRole string
	var stdinBody bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://api.atlassian.com/admin/v1/orgs/{orgId}/users/{userId}/role-assignments/revoke"
