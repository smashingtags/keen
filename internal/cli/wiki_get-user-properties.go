...
func newWikiGetUserPropertiesCmd(flags *rootFlags) *cobra.Command {
	var flagStart int
	var flagLimit int
	var flagAll bool
	...
	cmd.Flags().IntVar(&flagStart, "start", 0, "The starting index of the returned properties.")
	cmd.Flags().IntVar(&flagLimit, "limit", 5, "The maximum number of properties to return per page. Note, this may be restricted by fixed system limits.")
