...
func newAtlassianAccessUsersGetCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://api.atlassian.com/admin/v1/orgs/{orgId}/users"
			path = replacePathParam(path, "orgId", args[0])
			data, prov, err := resolvePaginatedRead(cmd.Context(), c, flags, "atlassian-access-users", path, map[string]string{
