...
func resourceSupportsPagination(resource string) bool {
	...
	case "addons":
		return true
	case "addons-archived":
		return true
	case "addons-listings-banners":
		return true
	case "addons_versions":
		return true
	case "agile":
		return true
	case "agile-1-0-epic-none-issue":
		return true
	case "app_access_settings":
		return true
	case "applications":
		return true
	...
	case "association":
		return true
	case "atlassian_access_events":
		return true
	case "atlassian_access_users":
		return true
	case "auditing":
		return true
	case "component":
	...
	case "fieldconfigurationscheme":
		return true
	case "fieldconfigurationscheme-mapping":
		return true
	case "fields":
		return true
	case "group":
	...
	case "issuetypescheme":
		return true
	case "issuetypescheme-mapping":
		return true
	case "issuetypescreenscheme":
		return true
	case "issuetypescreenscheme-mapping":
		return true
	case "issuetypescreenscheme_project":
		return true
	case "jira-cloud-platform-search":
		return true
	case "jira-cloud-platform-search-jql":
		return true
	...
	case "notificationscheme":
		return true
	case "notificationscheme-project":
		return true
	case "option":
		return true
	case "orgs":
	...
	case "project_component":
		return true
	case "project_issue_type_usages":
		return true
	case "reviews":
		return true
	case "screens":
	...
	case "servicedeskapi":
		return true
	case "servicedeskapi-assets-workspace":
		return true
	case "servicedeskapi-insight-workspace":
		return true
	case "servicedeskapi-organization":
		return true
	case "servicedeskapi-requesttype":
		return true
	case "servicedeskapi-servicedesk":
		return true
	case "software":
		return true
	case "statuses":
	...
	case "user":
		return true
	case "user-bulk-migration":
		return true
	case "users":
		return true
	case "users_last_active_dates":
		return true
	case "users_role_assignments":
		return true
	case "version":
		return true
	case "webhook":
	...
	case "wiki":
		return true
	case "wiki-rest-api-audit-since":
		return true
	case "wiki-rest-api-group":
		return true
	case "wiki-rest-api-longtask":
		return true
	case "wiki-rest-api-settings-theme":
		return true
...
func syncResourceFieldSelector(resource string) (string, string) {
	switch resource {
	case "agile":
		return "expand", "admins,location"
	case "field-search-trashed":
		return "expand", "lastUsed,schema"
	case "fieldconfiguration":
		return "id", "description,name"
	case "fieldconfigurationscheme":
		return "id", "id,description,name"
	case "fieldconfigurationscheme-mapping":
		return "fieldConfigurationSchemeId", "fieldConfigurationId,fieldConfigurationSchemeId,issueTypeId"
	case "filter":
		return "expand", "editPermissions,owner,sharePermissions,sharedUsers,subscriptions"
	case "filter-favourite":
		return "expand", "editPermissions,owner,sharePermissions,sharedUsers,subscriptions"
	case "issuesecurityschemes-level-member":
		return "expand", "holder"
	case "jira-cloud-platform-search":
		return "maxResults", "expand,issues.id,maxResults,startAt,total"
	case "jira-cloud-platform-search-jql":
		return "nextPageToken", "id,expand,key,self,transitions.id"
	case "jira-cloud-platform-workflow":
		return "expand", "id,operations,projects,schemes,statuses,transitions"
	case "notificationscheme":
		return "expand", "notificationSchemeEvents,scope"
	case "permissionscheme":
		return "expand", "permissions,scope"
	case "priorityscheme":
		return "expand", "priorities,projects"
	case "project":
		return "expand", "archivedBy,avatarUrls,components,deletedBy,insight,issueTypeHierarchy,issueTypes,landingPageInfo,lead,permissions,projectCategory,properties,roles,versions"
	case "project-recent":
		return "expand", "archivedBy,avatarUrls,components,deletedBy,insight,issueTypeHierarchy,issueTypes,landingPageInfo,lead,permissions,projectCategory,properties,roles,versions"
	case "screenscheme":
		return "expand", "issueTypeScreenSchemes,screens"
	case "servicedeskapi":
		return "expand", "values"
	case "servicedeskapi-requesttype":
		return "expand", "values"
	case "software":
		return "nextPageToken", "expand,isLast,issues.id,nextPageToken"
	case "ui-modifications":
		return "expand", "contexts"
	case "users":
		return "expand", "applicationRoles,avatarUrls,groups"
	case "wiki-rest-api-template-blueprint":
		return "expand", "body,labels,originalTemplate,space"
	case "wiki-rest-api-template-page":
		return "expand", "body,labels,originalTemplate,space"
	case "workflows":
		return "expand", "statuses,values"
	case "app_access_settings":
		return "cursor", "domain,enabled,numberOfProductsAppliesTo"
	case "field_screens":
		return "expand", "scope,tab"
	case "members":
		return "expand", "holder"
	case "version":
		return "expand", "approvers,issuesStatusForFixVersion,operations"
	case "wiki":
		return "expand", "details,operations,personalSpace,profilePicture"
	}
	return "", ""
}
...
func upsertSingleObject(db *store.Store, resource string, data json.RawMessage) error {
	...
	case "addon-categories":
		return db.UpsertAddonCategories(data)
	case "addons":
		return db.UpsertAddons(data)
	case "approval":
		return db.UpsertApproval(data)
	case "distribution":
		return db.UpsertDistribution(data)
	case "feedbacks":
		return db.UpsertFeedbacks(data)
	case "migration":
		return db.UpsertMigration(data)
	case "pricing":
		return db.UpsertPricing(data)
	case "privacy_and_security":
		return db.UpsertPrivacyAndSecurity(data)
	case "recommendations":
		return db.UpsertRecommendations(data)
	case "release":
		return db.UpsertRelease(data)
	case "reviews":
		return db.UpsertReviews(data)
	case "tokens":
		return db.UpsertTokens(data)
	case "addons_versions":
		return db.UpsertAddonsVersions(data)
	case "watch":
		return db.UpsertWatch(data)
	case "agile":
		return db.UpsertAgile(data)
	case "announcement-banner":
		return db.UpsertAnnouncementBanner(data)
	case "app":
		return db.UpsertApp(data)
	case "app-access-settings":
		return db.UpsertAppAccessSettings(data)
	...
	case "applications_versions":
		return db.UpsertApplicationsVersions(data)
	case "atlassian-access-events":
		return db.UpsertAtlassianAccessEvents(data)
	case "atlassian-access-groups":
		return db.UpsertAtlassianAccessGroups(data)
	case "atlassian-access-users":
		return db.UpsertAtlassianAccessUsers(data)
	case "role_assignments":
		return db.UpsertRoleAssignments(data)
	case "roles":
	...
	case "devinfo":
		return db.UpsertDevinfo(data)
	case "devopscomponents":
		return db.UpsertDevopscomponents(data)
	case "directories":
		return db.UpsertDirectories(data)
	case "directories_groups":
		return db.UpsertDirectoriesGroups(data)
	case "directories_users":
		return db.UpsertDirectoriesUsers(data)
	case "domains":
		return db.UpsertDomains(data)
	case "events":
		return db.UpsertEvents(data)
	case "events-stream":
		return db.UpsertEventsStream(data)
	case "expression":
	...
	case "license-types":
		return db.UpsertLicenseTypes(data)
	case "mypreferences":
	...
	case "operations":
		return db.UpsertOperations(data)
	case "orgs":
	...
	case "project_versions":
		return db.UpsertProjectVersions(data)
	...
	case "remotelinks":
		return db.UpsertRemotelinks(data)
	case "resolution":
	...
	case "vendors_addons":
		return db.UpsertVendorsAddons(data)
	case "partner_metrics":
		return db.UpsertPartnerMetrics(data)
	case "promotions":
		return db.UpsertPromotions(data)
	case "reporting":
		return db.UpsertReporting(data)
	case "webhook":
...
func defaultSyncResources() []string {
	return []string{
		...
		"screenscheme",
		"servicedeskapi",
		"servicedeskapi-assets-workspace",
		"servicedeskapi-insight-workspace",
		"servicedeskapi-organization",
		"servicedeskapi-requesttype",
...
func syncResourcePath(resource string) (string, error) {
	paths := map[string]string{
		"addons":                    "/addons",
		"addons-archived":           "/addons/archived",
		"addons-listings-banners":   "/addons/listings/banners",
		...
		"wiki-rest-api-group":                      "/wiki/rest/api/group",
		"wiki-rest-api-longtask":                   "/wiki/rest/api/longtask",
...
func dependentResourceDefs() []dependentResourceDef {
	return []dependentResourceDef{
		{Name: "addons_versions", ParentTable: "addons", ParentIDParam: "addonKey", PathTemplate: "/addons/{addonKey}/versions", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "addonKey", Field: "key"},
		}},
		{Name: "agile", ParentTable: "filter", ParentIDParam: "filterId", PathTemplate: "/rest/agile/1.0/board/filter/{filterId}", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "filterId", Field: "id"},
		}},
		{Name: "app_access_settings", ParentTable: "orgs", ParentIDParam: "orgId", PathTemplate: "/v2/orgs/{orgId}/app-access-settings/domains", KeyField: "", PathParams: []dependentPathParamDef{
		...
		{Name: "domains", ParentTable: "orgs", ParentIDParam: "orgId", PathTemplate: "/v1/orgs/{orgId}/domains", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "orgId", Field: "id"},
		}},
		{Name: "events_stream", ParentTable: "orgs", ParentIDParam: "orgId", PathTemplate: "/v1/orgs/{orgId}/events-stream", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "orgId", Field: "id"},
		}},
		...
		{Name: "users_role_assignments", ParentTable: "users", ParentIDParam: "accountId", PathTemplate: "/v2/orgs/{orgId}/directories/{directoryId}/users/{accountId}/role-assignments", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "orgId", Field: "orgs_id"},
			{Param: "directoryId", Field: "directories_id"},
			{Param: "accountId", Field: "id"},
		}},
		...
		{Name: "directories_groups", ParentTable: "directories", ParentIDParam: "directoryId", PathTemplate: "/v2/orgs/{orgId}/directories/{directoryId}/groups", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "orgId", Field: "orgs_id"},
			{Param: "directoryId", Field: "id"},
		}},
		{Name: "directories_users", ParentTable: "directories", ParentIDParam: "directoryId", PathTemplate: "/v2/orgs/{orgId}/directories/{directoryId}/users", KeyField: "", PathParams: []dependentPathParamDef{
			{Param: "orgId", Field: "orgs_id"},
			{Param: "directoryId", Field: "id"},
		}},
