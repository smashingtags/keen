...
func newDirectoriesUsersGetDirectoryDetailsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://api.atlassian.com/admin/v2/orgs/{orgId}/directories/{directoryId}/users/{userId}"
			...
			path = replacePathParam(path, "userId", args[3])
			params := map[string]string{}
			params["accountId"] = args[2]
