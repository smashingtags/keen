...
func newAppAccessSettingsGetDomainCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "app-access-settings", false, path, params, nil, cmd.ErrOrStderr())
			if err != nil {
