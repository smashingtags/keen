...
func newProjectPermissionschemeAssignPermissionSchemeCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().IntVar(&bodyId, "id", 0, "The ID of the permission scheme to associate with the project.")
