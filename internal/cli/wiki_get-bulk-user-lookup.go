...
func newWikiGetBulkUserLookupCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagAccountId, "account-id", "", "A list of accountId's of users to be returned.")
