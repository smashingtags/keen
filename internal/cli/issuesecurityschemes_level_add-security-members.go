...
func newIssuesecurityschemesLevelAddSecurityMembersCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&bodyMembers, "members", "", "The list of level members which should be added to the issue security scheme level.")
