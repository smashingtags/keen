...
func newWikiRemoveLabelFromContentUsingQueryParameterCmd(flags *rootFlags) *cobra.Command {
	var flagName string
	...
	cmd.Flags().StringVar(&flagName, "name", "", "The name of the label to be removed.")
