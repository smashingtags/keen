...
and full resync. After archiving, use 'search' for instant full-text search.`,
  ...
  jira-pp-cli-pp-cli workflow archive --full`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			resources := []string{"addons", "addons-archived", "addons-listings-banners", "addons-search-brief", "agile", "agile-1-0-epic-none-issue", "application-properties", "application-properties-advanced-settings", "applicationrole", "applications", "assets", "atlassian-connect", "auditing", "classification-levels", "component", "config", "configuration", "dashboard", "dashboard-gadgets", "data-policy", "events", "field", "field-search-trashed", "fieldconfiguration", "fieldconfigurationscheme", "fieldconfigurationscheme-mapping", "filter", "filter-favourite", "forge", "group", "group-member", "groups", "issuesecurityschemes", "issuesecurityschemes-level", "issuesecurityschemes-level-member", "issuesecurityschemes-project", "issuetype", "issuetypescheme", "issuetypescheme-mapping", "issuetypescreenscheme", "issuetypescreenscheme-mapping", "jira-cloud-platform-search", "jira-cloud-platform-search-jql", "jira-cloud-platform-workflow", "jql", "jql-autocompletedata-suggestions", "label", "license-types", "notificationscheme", "notificationscheme-project", "orgs", "permissions", "permissionscheme", "plans", "priority", "priorityscheme", "products", "project", "project-category", "project-recent", "project-type", "project-type-accessible", "resolution", "role", "screens", "screenscheme", "servicedeskapi", "servicedeskapi-assets-workspace", "servicedeskapi-insight-workspace", "servicedeskapi-organization", "servicedeskapi-requesttype", "servicedeskapi-servicedesk", "settings", "software", "status", "statuscategory", "statuses", "ui-modifications", "user", "user-bulk-migration", "user-columns", "user-properties", "users", "webhook", "webhook-failed", "wiki", "wiki-rest-api-audit-since", "wiki-rest-api-content-states", "wiki-rest-api-group", "wiki-rest-api-longtask", "wiki-rest-api-settings-theme", "wiki-rest-api-template-blueprint", "wiki-rest-api-template-page", "workflows", "workflowscheme"}
			totalSynced := 0
