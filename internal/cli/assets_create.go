...
func newAssetsCreateCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://marketplace.atlassian.com/rest/2/assets/artifact"
	...
	cmd.Flags().StringVar(&bodyFile, "file", "", "The relative location and name of the artifact file to be uploaded")
