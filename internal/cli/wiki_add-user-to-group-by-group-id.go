...
func newWikiAddUserToGroupByGroupIdCmd(flags *rootFlags) *cobra.Command {
	...
	cmd.Flags().StringVar(&flagGroupId, "group-id", "", "GroupId of the group whose membership is updated")
